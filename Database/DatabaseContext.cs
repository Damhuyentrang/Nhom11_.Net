...
namespace BTL_nhom11_marketPC.Database
{
    class DatabaseContext
    {
        ...
        private static string connStr = @"Data Source=CAPCAP\SQLEXPRESS;Initial Catalog=CuaHangPhanMemMayTinh;Integrated Security=True;Encrypt=False;TrustServerCertificate=True";
